...
def single_agent_args():
    custom_parameters = [
        ...
        {"name": "--condition-dim", "type": int, "default":512, "help": "language conditioned dimension"},
        {"name": "--rank", "type": int, "default":8, "help": "lora rank"},
        {"name": "--use-predict-cost","action":"store_true","help": "wheather to use TL conditioned"},
        {"name": "--use-credit-assignment", "action":"store_true", "help": "wheather to use TLmodel to credit assignment"},
        {"name": "--is-lava","action":"store_true","help": "if lava"},
        {"name": "--use-lora", "type": bool, "default":True, "help": "wheather to use lora"},
        {"name": "--is-finetune", "type": bool, "default":True, "help": "wheather finetune encode model"},
        {"name": "--language-model", "type": str, "default":"TLmodel", "help": "which language model to use"},
        {"name": "--test_model_path", "type": str, "default":"TLmodel", "help": "which language model to use"},
        {"name": "--TL-loadpath", "type": str, "default":"/trained_model/", "help": "which language model to use"},
        {"name": "--use-eval", "type": lambda x: bool(strtobool(x)), "default": False, "help": "Use evaluation environment for testing"},
        {"name": "--task", "type": str, "default": "MiniGrid", "help": "The task to run"},
        {"name": "--num-envs", "type": int, "default": 12, "help": "The number of parallel game environments"},
        ...
        {"name": "--device", "type": str, "default": "gpu", "help": "The device to run the model on"},
        ...
        {"name": "--lagrangian-multiplier-init", "type": float, "default": 0.1, "help": "initial value of lagrangian multiplier"},
